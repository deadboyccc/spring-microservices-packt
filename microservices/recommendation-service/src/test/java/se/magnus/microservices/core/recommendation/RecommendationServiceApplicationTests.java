...
class RecommendationServiceApplicationTests extends MongoDbTestBase {
    ...
    void getRecommendationsByProductId() {
        ...
        assertEquals(3, (long) repository.findByProductId(productId)
                .count()
                .block());
    ...
    void deleteRecommendations() {
        ...
        sendCreateRecommendationEvent(productId, recommendationId);
        assertEquals(1, (long) repository.findByProductId(productId)
                .count()
                .block());

        sendDeleteRecommendationEvent(productId);
        assertEquals(0, (long) repository.findByProductId(productId)
                .count()
                .block());
    ...
    private void sendCreateRecommendationEvent(int productId,
